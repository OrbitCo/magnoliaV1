...
class Scaffolding
{
    ...
    public function edit()
    {
        ...
        // Run the query
        $query = $this->CI->db->get_where($this->current_table, [$primary => $id]);
    ...
    public function update()
    {
        ...
        // Now do the query
        $this->CI->db->update($this->current_table, $_POST, [$primary => $this->CI->uri->segment(4)]);
    ...
    public function delete()
    {
        ...
        $data = [
                        ...
                        'message'      => $message,
                        'no'           => anchor([$this->base_uri, 'view'], (!isset($this->lang['scaff_no'])) ? 'No' : $this->lang['scaff_no']),
                        'yes'          => anchor([$this->base_uri, 'do_delete', $this->CI->uri->segment(4)], (!isset($this->lang['scaff_yes'])) ? 'Yes' : $this->lang['scaff_yes']),
                    ];
    ...
    public function do_delete()
    {
        ...
        header("Refresh:0;url=" . site_url([$this->base_uri, 'view']));
        exit;
    }
}
