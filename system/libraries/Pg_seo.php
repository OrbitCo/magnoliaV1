...
class CI_Pg_seo
{
    ...
    public function parse_seo_data($settings)
    {
        ...
        if (isset($this->seo_dynamic_data['og_description'])) {
            $settings['og_description'] = $this->seo_dynamic_data['og_description'];
        }
        if (isset($this->seo_dynamic_data['og_title'])) {
            $settings['og_title'] = $this->seo_dynamic_data['og_title'];
        }
    ...
    public function url_template_transform($module, $method, $data, $from, $to)
    {
        ...
        if ($from === "base" && $to === "scheme") {
            ...
            $auth_prefix = ($parsed[0]['value'] == 'admin/') ? 'admin/' : '';
