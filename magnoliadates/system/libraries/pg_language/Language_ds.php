...
class Language_ds
{
     ...
     * @return void
     */
    public function set_module_reference($module_gid, $gid, $strings_data = [], $lang_id = '')
    {
        if (empty($lang_id)) {
            $lang_id = $this->current_lang_id;
        }
     ...
     * @return void
     */
    public function delete_references($module_gid, $gids = [])
    {
    ...
    {
        $this->driver->delete_module_reference($module_gid, [$gid]);
        $this->get_module($module_gid);
    }
