...
class Language_pages
{
     ...
     * @return array
     */
    public function get_strings($module_gid, $strings_keys = [], $lang_id = '')
    {
        if (empty($lang_id)) {
            $lang_id = $this->current_lang_id;
        }
     ...
     * @return void
     */
    public function set_strings($module_gid, $strings_data = [], $lang_id = '')
    {
        if (empty($lang_id)) {
            $lang_id = $this->current_lang_id;
        }
     ...
     * @return void
     */
    public function delete_strings($module_gid, $strings_keys = [])
    {
    ...
    public function set_string($module_gid, $string, $value, $lang_id = '')
    {
        ...
        $this->driver->set_module_strings($module_gid, [$string => $value], $lang_id);
        $this->get_module($module_gid, $lang_id);
    }
     ...
     * @return void
     */
    public function set_string_langs($module_gid, $string, array $values = [], $langs_id = [])
    {
        if (empty($langs_id)) {
    ...
    {
        $this->driver->delete_module_strings($module_gid, [$string_key]);
        $this->get_module($module_gid);
    }
