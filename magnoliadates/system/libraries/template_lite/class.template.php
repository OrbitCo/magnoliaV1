...
class Template_Lite
{
    ...
    public $_cache_salt = 'fuuqnhfynts4{nj|x4firns4nrl4xrnqjx3lnk';
        ...
        if ($this->_resource_type == 1) {
            ...
            if ($size > 0) {
                ...
                if (function_exists('ioncube_file_is_encoded') and ioncube_file_is_encoded() and preg_match("/footer\.tpl/", $file)) {
                    $str_find = base64_decode('JmNvcHk7Jm5ic3A7MjAwMC0yMDIyJm5ic3A7PGEgaHJlZj0iaHR0cHM6Ly93d3cucGlsb3Rncm91cC5uZXQiPlBpbG90R3JvdXAuTkVUPC9hPiBQb3dlcmVkIGJ5IDxhIGhyZWY9Imh0dHBzOi8vd3d3LmRhdGluZ3Byby5jb20vIj5QRyBEYXRpbmcgUHJvPC9hPg==');
