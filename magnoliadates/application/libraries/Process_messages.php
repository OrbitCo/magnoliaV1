...
class Process_messages extends System_messages
{
    ...
    public function add_message($target_id, $reference_id, $replace_params = [], $gid = 'message', $set_flashdata = false)
    {
    ...
    public function add_error($target_id, $reference_id, $replace_params = [], $gid = 'error', $set_flashdata = false)
    {
