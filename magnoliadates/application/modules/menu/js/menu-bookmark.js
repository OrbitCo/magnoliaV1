function menuBookmark(optionArr)
{
    ...
    this.Init = function (options) {
        ...
        if (iter > 0) {
            ...
            $('#' + _self.properties.bmID + ' ' + _self.properties.bmElement).on('click', function () {
                if (!$(this).hasClass(_self.properties.bmExeptClass)) {
                    _self.active_item($(this));
                }
            });
            $('#' + _self.properties.bmID + ' ' + _self.properties.bmElement).on('mouseenter', function () {
                if (!$(this).hasClass(_self.properties.bmExeptClass)) {
                    _self.active_item($(this));
                }
            });
...
if (typeof exports === 'object') {
    ...
    exports.menuBookmark = menuBookmark;
}
