...
class ApiPolls extends \Controller
{
    ...
    */
    public function poll()
    {
        ...
        $this->set_api_content('data', ['poll' => $poll]);
    }
    ...
    */
    public function saveResult()
    {
        ...
        $data = ['poll' => $poll, 'max_results' => $max_results, 'max_answers' => $max_answers];
    ...
    */
    public function pollsList()
    {
        ...
        $this->set_api_content('data', ['polls' => $polls, 'language' => $language]);
    }
}
