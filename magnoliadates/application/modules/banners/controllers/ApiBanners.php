...
class ApiBanners extends \Controller
{
    ...
    */
    public function go()
    {
        ...
        $this->set_api_content('data', ['url' => $url]);
    }
    ...
    */
    public function my()
    {
        ...
        $banners = $this->Banners_model->get_banners($page, $items_on_page, ['id' => 'DESC'], $params);
        ...
        if ($banners) {
            ...
            $this->set_api_content('data', ['banners' => $banners]);
        } else {
    ...
    */
    public function get_places()
    {
        ...
        $this->load->model('banners/models/Banner_place_model');
        $this->set_api_content('data', ['places' => $this->Banner_place_model->get_all_places($access)]);
    }
    ...
    */
    public function save()
    {
        ...
        if (!empty($validate_data['errors'])) {
            ...
            $this->set_api_content('data', ['banner_id' => $banner_id]);
        }
    }
    ...
    */
    public function activate()
    {
        ...
        if ($validate['sum'] <= 0) {
            ...
            post_location_request(site_url() . 'services/form/banner_service', ['price' => $validate['sum'], 'id_banner_payment' => $banner_id]);
        }
        foreach ($groups as $k => $group) {
            $groups[$k]['user_positions'] = !empty($info['positions'][$group['id']]) ? $info['positions'][$group['id']] : 0;
        }
        $this->set_api_content('data', ['service_data' => $service_data, 'groups' => $groups]);
    }
