...
class AdminBanners extends \Controller
{
     ...
     * @return void
     */
    protected function _get_groups($place_id, $banner_id = null, $banner_groups = [])
    {
        $this->load->model('banners/models/Banner_place_model');
        ...
        if ($banner_id) {
            ...
            $banner_groups = (isset($banner['banner_groups']) and is_array($banner['banner_groups'])) ? $banner['banner_groups'] : [];
     ...
     * @return void
     */
    protected function _show_form($banner_type = null, $banner_id = null, $default_data = [])
    {
    ...
    public function edit_group($id = null)
    {
        ...
        if (!empty($data)) {
            $t = $this->Banner_group_model->format_group([0 => $data]);
            $data = $t[0];
        }
