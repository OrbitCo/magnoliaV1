...
/**
 * VirtualGifts model to forge database
 *
 * @package     PG_Dating
 ...
 * @author      DATING PRO LTD <http://www.pilotgroup.net/>
 */
class VirtualGiftsForgeModel extends \Model
{
    /**
     * Table name
     *
     * @var string
     */
    public static $MODULE_TABLE = '';

    /**
     * Constructor
     *
     * return VirtualGifts_forge_model
     */
    public function __construct()
    {
        self::$MODULE_TABLE = DB_PREFIX . "virtual_gifts";
