function GiftMedia(optionArr)
{
    this.properties = {
        gallery_name: 'giftsgallery',
        siteUrl: '/',
        idProduct: 0,
        mediaId: '',
        count_photo: 0,
        photoSize: 'smalle',
        deleteMediaUrl: 'admin/virtual_gifts/product_media_delete_',
        deleteMediaUrlReplace: 'admin/virtual_gifts/ajax_product_media_delete_',
        viewMediaUrl: 'admin/virtual_gifts/ajax_view_product_media',
        galleryContentDiv: 'gift_photos',
        galleryContentUrl: 'admin/virtual_gifts/ajax_get_gift_images',
    ...
    this.init_item_block_info = function () {
        $('#' + _self.properties.galleryContentDiv)
                .off('click', '[data-click="view-media-photo"]').on('click', '[data-click="view-media-photo"]', function (event) {
                ...
                .off('click', '[data-click="view-media-video"]').on('click', '[data-click="view-media-video"]', function (event) {
                    event.preventDefault();
                    var id_product = $(this).data('id-product') ? $(this).data('id-product') : _self.properties.idProduct;
                    var id_media = 0;
    ...
    this.init_links = function () {
        $(_self.properties.galleryPageButton).unbind('click').on('click', function () {
            _self.next_page();
        });
        $(_self.properties.refreshRecentPhotosButton).unbind('click').on('click', function () {
    ...
    this.get_post_data = function () {
        ...
        if ($('#' + _self.properties.sorterId).length) {
