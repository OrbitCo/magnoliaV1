function albums(optionArr)
{
    ...
    this.init_albums = function () {
        $(_self.properties.contentDiv).off('click', _self.properties.createAlbumButton).on('click', _self.properties.createAlbumButton, function () {
            $(_self.properties.createAlbumContainer).toggleClass('hide').find('input[type="text"]').focus();
    ...
    this.create_album = function () {
        ...
        $.ajax({
            ...
            success: function (resp) {
                if (resp.status) {
                    var prop = '';
                    if (_self.properties.permissions.option) {
                    ...
                    $('#user_albums').append('<div class="clearfix album album-item" id="user_album_' + resp.data.album_id + '"><input type="checkbox"> <span title="' + name + '">' + name + '</span>' +
                        '<div class="fright" data-toggle="tooltip" title="' +  prop + '">' +
