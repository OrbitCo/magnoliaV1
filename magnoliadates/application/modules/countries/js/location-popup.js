function locationPopUp(optionArr)
{
    ...
    this.Init = function (options) {
        ...
        $('#' + _self.properties.id_open).on('click', function () {
    ...
    this.open_form = function (type, variable) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#' + _self.properties.id_clear).unbind().on('click', function () {
                    _self.clearBox();
                });
                if (type == 'country') {
                    ...
                    $('#' + _self.properties.id_back).unbind().on('click', function () {
    ...
    this.generate_city_pages = function (pages, current_page, search) {
        ...
        if (pages > 1) {
            ...
            $('#' + _self.properties.id_city_page + ' a').on('click', function () {
...
if (typeof exports === 'object') {
    ...
    exports.locationPopUp = locationPopUp;
}
