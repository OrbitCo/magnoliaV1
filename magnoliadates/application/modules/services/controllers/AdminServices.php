...
class AdminServices extends \Controller
{
    ...
    {
        $order_by["gid"] = "ASC";
        $services = $this->Services_model->get_service_list([], null, $order_by);
        ...
        $addable_templates = $this->Services_model->get_template_count(["where" => ["moveable" => "1"]]);
    ...
    public function edit($service_id = null)
    {
        ...
        if (!empty($data)) {
            $t = $this->Services_model->format_services([0 => $data]);
            $data = $t[0];
        }
    ...
    {
        $order_by["gid"] = "ASC";
        $templates = $this->Services_model->get_template_list([], null, $order_by);
        $this->view->assign('templates', $templates);
