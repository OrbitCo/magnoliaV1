...
CREATE TABLE IF NOT EXISTS `[prefix]kisses_users` (
	...
	`message` blob NOT NULL COMMENT 'kiss message',
	`date_created` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
(null, '62883cea90.png', 1, 22, 'Hey, handsome :)', '2017-12-19 20:50:38', 0),
(null, '8e60a9ed62.png', 23, 30, '', '2017-12-22 11:55:05', 0),
(null, 'd4e665c01d.png', 15, 30, '', '2017-12-22 11:55:18', 0),
(null, '289dc7bcc9.png', 26, 30, '', '2017-12-22 11:56:22', 0),
(null, 'fe9a1940ef.png', 14, 30, '', '2017-12-22 11:57:35', 0);
