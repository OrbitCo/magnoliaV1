...
class SendMoneyInstallModel extends \Model
{
    ...
    protected $menu = [
                ...
                "other_items" => [
                    ...
                    "items"  => [
                        "add_ons_items" => [
                            "action" => "none",
                            "items"  => [
                                "send_money_menu_item" => ["action" => "create", "link" => "admin/send_money/index", "status" => 1, "sorter" => 1],
                            ],
                        ],
                    ],
                ],
        ...
        'admin_send_money_menu' => [
            'action' => 'create',
            'name'   => 'Admin mode - Add-ons - Send money menu',
            'items'  => [
                'send_money_settings_item' => ['action' => 'create', 'link' => 'admin/send_money/settings', 'status' => 1, "sorter" => 10],
                'send_money_view_item'     => ['action' => 'create', 'link' => 'admin/send_money/view', 'status' => 1, "sorter" => 20],
            ],
        ],
    ];
    ...
    protected $moderators_methods = [
        ["module" => "send_money", "method" => "index", "is_default" => 1, 'group_id' => 7, 'is_hidden' => 0, 'parent_module' => '']
    ];
    ...
    protected $notifications = [
        "templates" => [
            ["gid" => "send_money_msg", "name" => "Send money message", "vars" => ["money", "approve", "decline", "id", "sender"], "content_type" => "html"],
        ],
        "notifications" => [
            ['gid' => 'send_money_msg', 'send_type' => 'simple'],
        ],
    ];
