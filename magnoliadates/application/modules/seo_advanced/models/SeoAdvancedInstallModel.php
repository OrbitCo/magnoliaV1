...
class SeoAdvancedInstallModel extends \Model
{
        ...
        'admin_seo_menu' => [
            ...
            'items' => [
                'seo_advanced_main' => [
                    ...
                    'sorter' => 2,
                    'items' => [
                        'seo_advanced_list_item' => ['action' => 'create', 'link' => 'admin/seo_advanced/listing', 'status' => 1, 'sorter' => 1],
                        //'seo_advanced_analytics' => array('action' => 'create', 'link' => 'admin/seo_advanced/analytics', 'status' => 1, 'sorter' => 2),
                        'seo_advanced_tracker' => ['action' => 'create', 'link' => 'admin/seo_advanced/tracker', 'status' => 1, 'sorter' => 3],
                        'seo_advanced_robots' => ['action' => 'create', 'link' => 'admin/seo_advanced/robots', 'status' => 1, 'sorter' => 4],
                        'seo_advanced_site_map' => ['action' => 'create', 'link' => 'admin/seo_advanced/site_map', 'status' => 1, 'sorter' => 5],
                    ],
                ],
            ],
        ],
    ...
    protected $moderators_methods = [
        ['module' => 'seo_advanced', 'method' => 'index', 'is_default' => 1, 'group_id' => 1, 'is_hidden' => 1, 'parent_module' => 'seo']
    ];
    ...
    public function arbitraryDeinstalling()
    {
        ...
        $lang_dm_data['where'] = ['module' => 'seo_advanced', 'model' => 'Seo_advanced_model'];
