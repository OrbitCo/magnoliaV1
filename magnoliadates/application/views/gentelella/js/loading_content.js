function loadingContent(optionArr){
    ...
    this.active_close = function(){
        ...
        $("#" + _self.properties.closeBtnID + ', #' + _self.properties.closeBtnID + '_header').on('click', function(){
            _self.hide_load_block();
        });
    }
    ...
    this.create_close = function(){
        $("#" + _self.properties.loadBlockID + '_header').append(
            '<div id="' + _self.properties.closeBtnID + '_header"><i class="fas fa-window-close"></i></div>'
        );
