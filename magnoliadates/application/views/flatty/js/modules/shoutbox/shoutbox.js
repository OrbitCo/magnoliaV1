function Shoutbox(params)
{
    ...
    _p.renderMessages = function (messages, type) {
        ...
        for (var i in messages) {
            if (messages.hasOwnProperty(i) && typeof messages[i].user_info !== 'undefined') {
                if (!$('#shoutbox_msg_' + messages[i].id).length) {
                    var user_name = '';
        ...
        var actions = [
            {
                ...
                params: {module: 'shoutbox', model: 'ShoutboxModel', method: 'backendCheckNewMessages', 'max_id': _p.getMaxId},
                paramsFunc: function () {
                    return {};
                },
    ...
    this.showShoutbox = function () {
      ...
      _p.shoutboxBlockObj.removeClass('hide').fadeIn();
