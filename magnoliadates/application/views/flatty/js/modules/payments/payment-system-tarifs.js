function PaymentSystemTarifs(optionArr)
{
    ...
    this.Init = function (options) {
        ...
        _self.set_sortable();
        $('#'+_self.properties.addBtnId).on('click', function () {
    ...
    this.set_sortable = function () {
        ...
        $("#"+_self.properties.sortId+' > li').each(function () {
            ...
            $(this).find('.add_link').on('click', function () {
                _self.add_operator_tarif(operator_gid);
                return false;
            });

            $(this).find('.remove_link').on('click', function () {
            ...
            $(this).find('.activate_link').on('click', function () {
                _self.activate_operator(operator_gid);
                return false;
            });

            $(this).find('.deactivate_link').on('click', function () {
    ...
    this.get_operator_form = function (operator_gid) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#'+_self.properties.cancelBtnId).on('click', function () {
...
if (typeof exports === 'object') {
    ...
    exports.PaymentSystemTarifs = PaymentSystemTarifs;
}
