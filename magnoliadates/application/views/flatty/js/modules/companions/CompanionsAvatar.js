'use strict';
function CompanionsAvatar(optionArr)
{
    this.properties = {
        site_url: '',
    ...
    this.load_avatar = function () {
        $.ajax({
            ...
            type: 'POST',
            data: { 'id_obj': _self.properties.id_obj, 'id_user': _self.properties.id_user },
            dataType: 'json',
            cache: false,
    ...
    this.recrop = function () {
        ...
        xhr_recrop = $.ajax({
            ...
            type: 'POST',
            data: { 'selections': _self.selections[_self.index], 'id_obj': _self.properties.id_obj },
            dataType: 'json',
            cache: false,
            success: function (resp) {
                if (resp.status) {
...
if (typeof exports === 'object') {
    ...
    exports.CompanionsAvatar = CompanionsAvatar
}
