function events_media(optionArr)
{
    ...
    this.init_links = function () {
        $('#' + _self.properties.addPhotoID).unbind('click').on('click', function () {
            _self.display_upload_photos_form();
        });
        $('#' + _self.properties.addVideoID).unbind('click').on('click', function () {
            _self.display_upload_video_form();
        });
        $('#' + _self.properties.addAudioID).unbind('click').on('click', function () {
...
if (typeof exports === 'object') {
    ...
    exports.events_media = events_media;
}
