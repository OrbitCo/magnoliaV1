function YandexMapsv2(defOptions)
{
    ...
    this.clear = function () {
        ...
        for (i in _self.markers) {
            if (!_self.prop.use_clusterer) {
                _self.removeEntry(_self.markers[i]);
            }
    ...
    this.remove = function () {
        _self.clear();
        if (_self.prop.use_clusterer) {
            _self.removeEntry(_self.clusterer);
        }
    ...
    this.addAmenities = function () {
        if (!_self.prop.amenities.length) {
            return false;
        }
    ...
    function Marker(map, latitude, longitude, defOptions)
    {
        ...
        this.init = function (latitude, longitude, options) {
            ...
            _self.marker = new ymaps.Placemark([latitude, longitude],
                marker_options,
                {
                    balloonOffset: [5, -25],
...
if (typeof exports === 'object') {
    ...
    exports.YandexMapsv2 = YandexMapsv2;
}
