function jsSelect(load_options){
	...
	this.init_select = function(obj){
		...
		$(_self.properties.element).on(_self.properties.openSelectAction, function(){
	...
	this.activate_select = function(){
		...
		$("#"+_self.properties.selectBlockID+" > ul > li").unbind().on('click', function(){
	...
	this.active_bg = function(){
		...
		$("#"+_self.properties.selectBlockBgID).on('click', function(){
			_self.deactivate_select();
		});
