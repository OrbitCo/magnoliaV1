...
$(opts.next).on('click',function(){return advance(els,opts,opts.rev?-1:1)});if(opts.prev)
$(opts.prev).on('click',function(){return advance(els,opts,opts.rev?1:-1)});if(opts.timeout)
