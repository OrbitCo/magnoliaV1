...
class AdminWallEvents extends \Controller
{
    private $other_settings = [
        'wall_events' => [
            ['var' => 'live_period', 'type' => 'text'],
            ['var' => 'events_max_count', 'type' => 'text'],
        ],
    ];
    ...
    public function index($page = 1)
    {
        ...
        $wall_events_types = $this->Wall_events_types_model->get_wall_events_types([], $page, $items_on_page);
    ...
    public function ajaxActivateType()
    {
        ...
        $this->Wall_events_types_model->saveWallEventsType($gid, ['status' => $status]);
