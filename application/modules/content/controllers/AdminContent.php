...
class AdminContent extends \Controller
{
        ...
        if ($this->input->post('btn_save')) {
            switch ($section_gid) {
                case 'text':
                    ...
                    $config_array = [$logo_config["max_size"], $logo_config["max_height"], $logo_config["max_width"]];
    ...
    public function promo($lang_id = 0, $content_type = '')
    {
        ...
        if ($this->input->post('btn_save_settings')) {
            $post_data = ["content_type" => $this->input->post('content_type', true)];
        ...
        if ($this->input->post('btn_save_content')) {
            switch ($content_type) {
                case 't':
                    ...
                    break;
                case 'f':
                    $validate_data = $this->Content_promo_model->validate_promo([], '', 'promo_flash');
