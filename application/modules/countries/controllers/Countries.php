...
class Countries extends \Controller
{
    ...
    public function ajaxGetCountries()
    {
        ...
        $countries = $this->Countries_model->get_countries($order_by, [], [], $lang_id);
    ...
    public function ajaxGetRegions($country_code)
    {
        ...
        $regions = $this->Countries_model->get_regions($country_code, $order_by, [], [], $lang_id);
    ...
    public function ajaxGetCities($id_region, $page = 1)
    {
        ...
        $return["items"] = array_values($this->Countries_model->get_cities($page, $items_on_page, $order_by, $params, [], $lang_id));
