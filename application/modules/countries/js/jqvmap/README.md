...
```js
jQuery('#vmap').on('load.jqvmap',
    function(event, map)
    {

    }
);
jQuery('#vmap').on('labelShow.jqvmap',
    function(event, label, code)
    {

    }
);
jQuery('#vmap').on('regionMouseOver.jqvmap',
    function(event, code, region)
    {

    }
);
jQuery('#vmap').on('regionMouseOut.jqvmap',
    function(event, code, region)
    {
