...
function options(optionArr) {
    ...
    var bindEvents = function () {
        _self.properties.btnOpen.on('click', function () {
            _self.openForm(_self.properties.selectedField);
        });
        _self.properties.bgBlock.on('click', function () {
            cancel();
        });
        _self.properties.btnClose.on('click', function () {
            cancel();
        });
        _self.properties.tabsList.on('click', function () {
            changeTab($(this).data('tab'));
        });
        _self.properties.btnApply.on('click', function () {
            if (apply()) {
                _self.closeForm();
            } else {
                return false;
        ...
        _self.properties.btnSelectAll.on('click', function () {
            if (allSelected()) {
        ...
        _self.properties.itemsList.on('selectstart mousedown', function () {
            return false;
        });
        _self.properties.itemsList.on('click', function () {
        ...
        _self.properties.selectedItemsBlock.on('click', function () {
