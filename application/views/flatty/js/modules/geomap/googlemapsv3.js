function GoogleMapsv3(defOptions)
{
    ...
    this.addSearchbox = function () {
        ...
        content.find('.map_search_keyword').on('keyup', function (e) {
            e = e || window.event;
            if (e.keyCode == 13) {
    ...
    this.addAmenities = function () {
        ...
        control.find('#' + _self.prop.map_container + ' .amenities_switch').on('click', function () {
...
if (typeof exports === 'object') {
    ...
    exports.GoogleMapsv3 = GoogleMapsv3;
}
