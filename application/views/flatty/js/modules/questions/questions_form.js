...
function Questions(optionArr)
{
    ...
    this.Init = function (options) {
        ...
        $(document)
            .off('click', '#' + _self.properties.btnForm).on('click', '#' + _self.properties.btnForm, function () {
    ...
    this.get_form = function () {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#' + _self.properties.btnRefresh).unbind().on('click', function () {
                    _self.refresh();
                });
            }
        });
        ...
        $.ajax({
            ...
            success: function (data) {
                if (typeof (data.error) != 'undefined' && data.error != '') {
                    ...
                    sendAnalytics('questions_send_question', 'communication', 'user');
                }
            }
        });
