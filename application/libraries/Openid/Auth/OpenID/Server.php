...
$_Auth_OpenID_Request_Modes = ['checkid_setup',
                                    'checkid_immediate', ];
...
class Auth_OpenID_ServerError
{
    ...
    public function toMessage()
    {
        ...
        if ($this->reference !== null) {
            $reply->setArg(Auth_OpenID_OPENID_NS,
                'reference',
                           $this->reference);
        }
...
class Auth_OpenID_DiffieHellmanSHA1ServerSession
{
    ...
    {
        $lib = Auth_OpenID_getMathLib();
        $mac_key = $this->dh->xorSecret($this->consumer_pubkey,
            $secret,
                                        $this->hash_func);
...
class Auth_OpenID_Decoder
{
    ...
    public function decode($query)
    {
        ...
        $handlerCls = Auth_OpenID::arrayGet($this->handlers,
            $mode,
