...
class Unzip
{
    ...
    {
        $this->fileName          = '';
        $this->compressedList    = []; // You will problably use only this one!
        $this->centralDirList    = []; // Central dir list... It's a kind of 'extra attributes' for a set of files
        $this->endOfCentral      = []; // End of central dir, contains ZIP Comments
        $this->info              = [];
        $this->error             = [];
